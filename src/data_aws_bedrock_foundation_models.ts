...
export class data_aws_bedrock_foundation_models extends TerraformResource {
  constructor(protected readonly terraformConfig: TerraformConfig, protected readonly resourceName: string, readonly args: DataAwsBedrockFoundationModelsArgs) {
    const meta = {};
