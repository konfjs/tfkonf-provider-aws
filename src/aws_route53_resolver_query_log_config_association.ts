...
export class aws_route53_resolver_query_log_config_association extends TerraformResource {
  constructor(protected readonly terraformConfig: TerraformConfig, protected readonly resourceName: string, readonly args: AwsRoute53ResolverQueryLogConfigAssociationArgs) {
    const meta = {};
