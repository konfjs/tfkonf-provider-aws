...
export class aws_opensearchserverless_lifecycle_policy extends TerraformResource {
  constructor(protected readonly terraformConfig: TerraformConfig, protected readonly resourceName: string, readonly args: AwsOpensearchserverlessLifecyclePolicyArgs) {
    const meta = {};
    super(terraformConfig, "resource", args, meta, "aws_opensearchserverless_lifecycle_policy", resourceName);
  }
