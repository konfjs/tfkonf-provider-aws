...
export class aws_opsworks_java_app_layer extends TerraformResource {
  constructor(protected readonly terraformConfig: TerraformConfig, protected readonly resourceName: string, readonly args: AwsOpsworksJavaAppLayerArgs) {
    ...
    super(terraformConfig, "resource", args, meta, "aws_opsworks_java_app_layer", resourceName);
  }
