...
export class aws_opsworks_ganglia_layer extends TerraformResource {
  constructor(protected readonly terraformConfig: TerraformConfig, protected readonly resourceName: string, readonly args: AwsOpsworksGangliaLayerArgs) {
    ...
    super(terraformConfig, "resource", args, meta, "aws_opsworks_ganglia_layer", resourceName);
  }
