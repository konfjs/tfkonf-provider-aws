...
export class aws_opsworks_custom_layer extends TerraformResource {
  constructor(protected readonly terraformConfig: TerraformConfig, protected readonly resourceName: string, readonly args: AwsOpsworksCustomLayerArgs) {
    ...
    super(terraformConfig, "resource", args, meta, "aws_opsworks_custom_layer", resourceName);
  }
